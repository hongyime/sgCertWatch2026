...
Current task: Telegram removal is released and verified on 2026-09-09. Dashboard-only scheduler is deployed paused; activation awaits the supplied token's repository Actions read/write permission, then real 24-hour observation. Do not request Telegram credentials again.
