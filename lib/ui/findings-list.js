 ...
 * @returns {string} HTML string
 */
export function renderFindingRow(finding, selectedFindingId) {
  return `
 ...
 * @returns {string} HTML string
 */
export function renderFindingTableBody(findings, selectedFindingId) {
  ...
  const tbody = findings.map((f) => renderFindingRow(f, selectedFindingId)).join('');
